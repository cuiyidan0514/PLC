function [Beta,b,weight]= PL_LEAF_train(train_data,train_p_target,k,ker,C1,C2,epsi,par,tol,weight)
...
disp('building label manifold...')
y=build_label_manifold(train_data,train_p_target,k);
%second phase of training
disp('optimizing beta and b...')
[Beta,b,weight] = plmsvr(train_data,y,train_p_target,ker,C1,C2,epsi,par,tol,weight);
end
