function [accuracy_test, best_acc, best_acc1, acc, all_energy, best_k] = PL_CL_MKL(train_data,train_p_target,test_data,test_target,k,ker,par,Maxiter,Maxiter1,lambda,mu,gama,al,beta)
...
% fix W,q,y, optimize weight,alpha,b
